...
//      - Chỉ gọi callback 1 lần sau khi component mounted (tính chất chung)
...
function Content() {
    ...
    useEffect(() => {
        return () =>  {
            // phải check xem avatar đang có tồn tại hay không thì mới cleanup
            // vì cleanup function luôn đc gọi trc khi callback đc gọi (trừ lần mounted)
