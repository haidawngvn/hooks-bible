...
// có thể dùng như 1 biến tổng để lưu gtri. Vd chức năng start, stop của Counter bên dưới
// tạo ra timerId bằng useRef() ==> gán nó bằng trong handleStart() ==> sau khi count giảm ==> re-render
// ===> vô handleStop() vẫn đem ra sd đc
...
function App(){
    ...
    useEffect(() => {
        // - callback luôn đc gọi 1 lần sau khi component mounted
        // nên sau khi mounted:
        //      + Ở lần đầu: vì name đc init là '' nên prevName.current = ''
        //      + Khi type name vô ===> cập nhật state ==> re-render component ==> set prevName.current = new text 
        prevName.current = name
    }, [name])

    return(
        <div style={{ padding : 20 }}>
            <h1>vi du 1, f8, 2nd common use</h1>
